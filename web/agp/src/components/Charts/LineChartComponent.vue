...
const resetZoom = () => {
  ...
  if (chartRef.value?.chartInstance) {
    console.log('Calling resetZoom on chart');
    chartRef.value.chartInstance.resetZoom();
    console.log('Reset zoom successful');
  } else {
    console.log('Chart instance not available for reset');
  }
};
...
const downloadChart = () => {
  ...
  if (chartRef.value?.chartInstance) {
    console.log('Calling toBase64Image on chart');
    try {
    ...
    console.log('Chart instance not available for download');
  }
};
</script>
